...
The Starter Kit demo uses the same public ASR visual family as the wider ecosystem while keeping the demo itself lightweight.

Active brand assets:

- `public/assets/asr_assets/ASR_Logo_Transparent.webp` — header/logo use
